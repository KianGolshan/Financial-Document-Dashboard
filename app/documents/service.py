...
def _investment_upload_dir(investment_name: str) -> Path:
...
async def upload_document(
    ...
    folder = _investment_upload_dir(investment.investment_name)
...
async def bulk_upload_documents(
    ...
    docs = []
    for file in files:
        doc = await upload_document(db, investment_id, file, document_name, document_date)
        docs.append(doc)
    return docs


def list_documents(db: Session, investment_id: int) -> tuple[list[Document], int]:
